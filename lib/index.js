(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["declarity-loader"] = factory();
	else
		root["declarity-loader"] = factory();
})(this, function() {
...
/* WEBPACK VAR INJECTION */(function(process) {function transform(source, map) {
...
`;
    ...
    const newSource = process.env.NODE_ENV === 'development' ? [prependText, source, appendText].join('\n\n') : [prependText, source].join('\n\n');
